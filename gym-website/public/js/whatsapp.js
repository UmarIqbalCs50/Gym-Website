  ...
  try {
    ...
    btn.innerHTML = `
      <svg viewBox="0 0 24 24" fill="currentColor" width="28" height="28">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.116.554 4.103 1.523 5.824L.057 23.852a.5.5 0 0 0 .609.61l6.098-1.597A11.94 11.94 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.9a9.9 9.9 0 0 1-5.031-1.374l-.361-.214-3.741.98.999-3.648-.235-.374A9.862 9.862 0 0 1 2.1 12C2.1 6.533 6.533 2.1 12 2.1c5.467 0 9.9 4.433 9.9 9.9 0 5.467-4.433 9.9-9.9 9.9z"/>
      </svg>
